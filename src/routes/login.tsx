    ...
    >
      <div className="w-full max-w-md">
        ...
        {MAINTENANCE_MODE && (
          <div
            role="status"
            className="mb-8 rounded-xl border border-primary/30 bg-primary/10 px-4 py-3"
          >
            <p className="text-xs font-semibold uppercase tracking-[0.08em] text-primary">
              Temporary maintenance
            </p>
            <p className="mt-1.5 text-sm leading-relaxed text-muted-foreground">
              Access is currently limited while final updates are completed. We expect the platform
              to be live again within the next couple of hours.
            </p>
          ...
          <>
            <div className="mb-8">
              ...
              <p className="text-sm text-muted-foreground mt-3 leading-relaxed">
                Sign in with your Mentor Hub account.
              </p>
            </div>
            ...
            >
              <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden="true">
                ...
                <path
                  fill="#1976D2"
                  d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.1 5.6l6.2 5.2C41.4 35.6 44 30.2 44 24c0-1.3-.1-2.4-.4-3.5z"
                />
              </svg>
            ...
            >
              <svg
                ...
                fill="currentColor"
              >
                <path d="M16.365 1.43c0 1.14-.42 2.24-1.18 3.04-.84.9-2.17 1.58-3.28 1.5-.13-1.11.42-2.28 1.14-3.02.83-.86 2.27-1.53 3.32-1.52zM20.5 17.09c-.55 1.27-.82 1.83-1.53 2.95-.98 1.56-2.37 3.5-4.09 3.51-1.53.01-1.93-1-4-1-2.08.01-2.51 1.02-4.04 1.01-1.72-.01-3.03-1.76-4.02-3.32C.06 16.68-.24 11.4 1.94 8.6 3.5 6.62 5.94 5.46 8.24 5.46c2.35 0 3.83 1.29 5.77 1.29 1.88 0 3.03-1.29 5.75-1.29 2.05 0 4.22 1.12 5.77 3.06-5.07 2.78-4.24 10.03-4.53 8.57z" />
              </svg>
              Continue with Apple
            </button>
