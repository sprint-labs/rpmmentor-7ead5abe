// mic - from AnimateIcons / Lucide (https://animateicons.in)
...
//
// Local note: the upstream file opens with a "use client" directive for Next's
// RSC boundary. This is a TanStack Start app with no server components, where
// the directive means nothing and only makes Rollup warn, so it is dropped.
