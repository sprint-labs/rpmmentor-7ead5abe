...
#boot-splash .bs-fill{display:none;position:absolute;left:0;top:0;width:134px;height:154px;background:linear-gradient(to bottom,rgba(18,196,0,0) 0%,rgba(18,196,0,0) 50%,#12C400 58%,#12C400 100%);background-size:100% 200%;background-repeat:no-repeat;-webkit-mask-image:url(/gkhq-mark.png);mask-image:url(/gkhq-mark.png);-webkit-mask-size:100% 100%;mask-size:100% 100%;-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-position:center;mask-position:center;animation:bs-rise 2.2s cubic-bezier(.45,0,.2,1) infinite}
